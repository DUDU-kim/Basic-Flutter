...
class _PlayerFullUI extends State<PlayerFullUI> {
  ...
  Timer? _rewindTimer;
  final Set<String> _selectedFavorites = {}; // 存被選中的清單名稱
  final Set<String> _tmpselectedFavorites = {}; // 存原被選中但後來要刪掉的清單名稱
  bool? _isSelected;
  bool flag = true;
                                              ...
                                              builder: (context, myPlaylistProvider, selectedProvider, child) {
                                                ...
                                                return ListView.builder(
                                                  ...
                                                  itemBuilder: (context, index) {
                                                    ...
                                                    final songsList = song['songs_list'];
                                                    final title = song['title'];
                                                    final artist = song['artist'];
                                                    final fileUrl = song['file_url'];
                                                    final musicCache = song['music_cache']; //music_cache(file_url)
                                                    final imageSmall = song['image_small']; //image_small(cover_url)
                                                    final imageMedium = song['image_medium'];
                                                        ...
                                                        ListTile(
                                                          leading:ClipRRect(
                                                            ...
                                                            child: imageSmall != null
                                                                ? Image.network(imageSmall, width: 50, height: 50, fit: BoxFit.cover)
                                                                : Container(
                                                              width: 50,
                                                              height: 50,
